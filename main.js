/*
Our Link: https://teachablemachine.withgoogle.com/models/s5yjAN_4a/
*/
...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/s5yjAN_4a/model.json', modelLoaded);
...
function gotResult(error, results){
    if(error){
        ...
        if(results[1].label=="Clapping"){
            document.getElementById("update_emoji_2").innerHTML="&#128075";
        }
        if(results[1].label=="Waving"){
            document.getElementById("update_emoji_2").innerHTML="&#128079";
        }
    }
}